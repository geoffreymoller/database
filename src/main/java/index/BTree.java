package index; /******************************************************************************
 *  Compilation:  javac index.BTree.java
 *  Execution:    java index.BTree
...
/**
 *  The {@code index.BTree} class represents an ordered symbol table of generic
 *  key-value pairs.
...
public class BTree<Key extends Comparable<Key>, Value>  {
    ...
    /**
     * Unit tests the {@code index.BTree} data type.
     *
